package com.example.wallet_service_micro.service;

import com.example.wallet_service_micro.client.UserClient;
import com.example.wallet_service_micro.config.WalletProperties;
import com.example.wallet_service_micro.dto.*;
import com.example.wallet_service_micro.exception.UserNotFoundException;
import com.example.wallet_service_micro.mapper.TransactionMapper;
import com.example.wallet_service_micro.mapper.WalletMapper;
import com.example.wallet_service_micro.model.Wallet;
import com.example.wallet_service_micro.repository.TransactionRepository;
...
import com.example.wallet_service_micro.service.wallet.WalletTransactionService;
import com.example.wallet_service_micro.service.wallet.WalletValidator;
...
public class WalletService {
    ...
    // LOAD MONEY
    // --------------------------------------------------------------------
    public LoadMoneyResponse loadMoney(UserDTO user, double amount, String transactionId) {
    ...
    public LoadMoneyResponse performLoadMoney(UserDTO user, double amount, String transactionId) {
        ...
        LoadMoneyResponse response = toLoadMoneyResponse(wallet);
